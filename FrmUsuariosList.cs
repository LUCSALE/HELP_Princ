...
{
    public partial class FrmUsuariosList : Form
    {
        ...
        private void FrmUsuariosList_Load(object sender, EventArgs e)
        {
        ...
        {
            InfoApp.opcao = "Incluir NOVO USUÁRIO";
        ...
        private void dbgTecnicos_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
            if (e.ColumnIndex == 0)
            {
                // Editar o registro
                // 
                InfoPesq.ID = (int)dbgUsuarios.CurrentRow.Cells[2].Value; // Pega o ID da pesquisa   
                InfoApp.opcao = "Editar DADOS USUÁRIO";
                FrmUsuariosForm UsuariosForm = new FrmUsuariosForm();
                UsuariosForm.ShowDialog();
            }
            ...
            if (e.ColumnIndex == 1)
            {
                ...
                string caption = "Exclusão do USUÁRIO";
                ...
                if (result == System.Windows.Forms.DialogResult.Yes)
                {
                    ...
                    string strSql = "DELETE FROM USUARIOS WHERE ID = @ID";
                    ...
                    try
                    {
                        ...
                        using (SqlConnection connection = new SqlConnection(strProvider))
                        {
                            ...
                            {
                                command.Parameters.AddWithValue("@ID", (int)dbgUsuarios.CurrentRow.Cells[2].Value); // Pega o ID da pesquisa   
        ...
        private void toolStripButton1_Click(object sender, EventArgs e)
        {
            ...
            FrmUsuariosExcel UsuariosExcel = new FrmUsuariosExcel();
            UsuariosExcel.ShowDialog();
